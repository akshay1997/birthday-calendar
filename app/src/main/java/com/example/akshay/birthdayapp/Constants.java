...
public class Constants {
    ...
    public static final String FULL_PACKAGE_NAME = "com.example.akshay.birthdayapp";

    public static final String ACCOUNT_NAME = "Birthday Adapter";
    public static final String ACCOUNT_TYPE = "com.example.akshay.birthdayapp.account";
